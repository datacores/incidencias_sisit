(function(API){
	...
	Paginador = function(){
		...
		/*
		 * Funcion callback que se ejecutará tras efectuar la paginación.
		 * A esta función se le pasaran 2 parametros, los datos paginados, y el propio objeto paginador,
		 * que se puede usar, por ejemplo, para obtener los datos originales antes de paginar con get_datos.
		 *
		 */
		this.callback = a[i+1] || 
			function(datos){ 
	...
	Paginador.prototype.get_datos = function(){
		return this.datos;
	}
