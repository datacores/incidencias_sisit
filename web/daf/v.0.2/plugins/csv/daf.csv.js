(function(CORE){
    ...
    CSV = function(){
         ...
         * Un metodo dentro del objeto formato, recibirá como paraemtro el registro a procesar y 
        ...
        this.nombre  = args[2] || new Date().getTime();
        this.ie      = args[3] || false;
    }
    ...
    CSV.prototype.set_datos = function(datos_recibidos){
        ...
        if(_.isObject(datos[0])) this.datos = datos;
