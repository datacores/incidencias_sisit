(function(){function f(a,c){var b=.1,d=setInterval(function(){1<=b&&(clearInterval(d),c&&c());a.style.opacity=b;a.style.filter="alpha(opacity="+100*b+")";b+=.1*b},1)}function g(a,c){var b=1,d=setInterval(function(){.1>=b?(clearInterval(d),c&&c()):(a.style.opacity=b,a.style.filter="alpha(opacity="+100*b+")",b-=.1*b)},1)}Modal=function(){var a=Array.prototype.slice.call(arguments,0);this.alto=screen.height;this.ancho=screen.width;this.body=document.getElementsByTagName("body")[0];this.modal_wrap=document.createElement("div");
...
!1),c[a[b].id].set_html(a[b]);return c};Confirmar=function(a,c,b,d){c=c||"OK";b=b||"Cancel";d=_.isFunction(d)?d:function(a){return a};var e=new Modal("450px","200px");e.set_html('<p style="margin-top:11px;">'+a+'</p><div style="position: absolute;bottom: 11px;left: 20px;width: 400px;"><hr style="margin-bottom:11px;" /><button id="ok" style="float:right;">'+c+'</button><button id="cancel" style="float:right;margin-right: 7px;">'+b+"</button></div>");e.abre_modal(function(a){a=$(a);a.find("button").off("click");
a.find("button").on("click",function(){e.cierra_modal();var a="ok"==$(this).attr("id")?!0:!1;d(a)})})}})();
