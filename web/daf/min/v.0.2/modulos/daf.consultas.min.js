...
c);this.nombre_consulta=null;this.html();this.comportamientos();this.leer_consultas()};Consulta.prototype.ejecutar_consulta=function(){var a=this.get_consulta_xFilas();this.ejecutar_callback(a)};Consulta.prototype.html=function(){var a=this;$("<div>",{id:"filtro"}).append($("<div>",{id:"cabecera"}).append($("<h3>",{text:"\u00c1rea de consultas"}),$("<div>",{id:"herramientas"}).append($('<select id="selector_consulta" style="height:100%;">',{}).append('<option value="-1">Seleccionar Consulta</option>'),
$("<button>",{id:"ver_consulta",text:"Ver",title:"Ver en modo edici\u00f3n la consulta selecciona"}),$("<button>",{id:"ejecutar_consulta",text:"Ejecutar",title:"Ejecutar consulta seleccionada."}),$("<button>",{id:"nueva_consulta",text:"Nueva",title:"Nueva consulta vacia."}),$("<button>",{id:"guardar_consulta",text:"Guardar",title:"Grabar o actualizar consulta actual"}),$("<button>",{id:"renombrar_consulta",text:"Renombrar",title:"Renombrar consulta actual"}),$("<button>",{id:"eliminar_consulta",text:"Borrar",
title:"Borrar consulta actual"}),$("<button>",{id:"reset_consulta",text:"Reset",title:"Resetea listado y consultas."}))),$("<div>",{id:"cuerpo",css:{display:"none"}}).append($("<table>").append($("<tr>").append($("<td>",{"class":"etqu",text:"Campo:"})),$("<tr>").append($("<td>",{"class":"etqu",text:"Ver:"})),$("<tr>").append($("<td>",{"class":"etqu",text:"Orden:"})),$("<tr>").append($("<td>",{"class":"etqu",text:"Criterio:"})),$("<tr>").append($("<td>",{"class":"etqu",text:"o:"})),$("<tr>").append($("<td>",
{"class":"etqu",text:"o:"})),$("<tr>").append($("<td>",{"class":"etqu",text:"o:"})),$("<tr>").append($("<td>",{"class":"etqu",text:"o:"})),$("<tr>").append($("<td>",{"class":"etqu",text:"o:"})),$("<tr>").append($("<td>",{"class":"etqu",text:"o:"})),$("<tr>").append($("<td>",{"class":"etqu",text:"o:"}))))).hide().appendTo(this.contenedor).fadeIn();b.find("#cabecera").after('<div style="margin: 6px 5px;display:none;">\r\n\t\t\t\t\t\t\t<h4>Nuevo nombre para la consulta</h4>\r\n\t\t\t\t\t\t\t<input type="text" id="nombre_renombrar" style="width: 300px;height:26px;" placeholder="Introduzca nombre..." />\r\n\t\t\t\t\t\t\t<button id="cancelar_renombrar">Cancelar</button>\r\n\t\t\t\t\t\t\t<button id="btn_renombrar">Renombrar</button>\r\n\t\t\t\t\t\t</div>').after('<div style="margin: 6px 5px;display:none;">\r\n\t\t\t\t\t\t\t<h4>Nombre de la consulta a guardar</h4>\r\n\t\t\t\t\t\t\t<input type="text" id="nombre_guardar" style="width: 300px;height:26px;" placeholder="Introduzca nombre..." />\r\n\t\t\t\t\t\t\t<button id="cancelar_guardar">Cancelar</button>\r\n\t\t\t\t\t\t\t<button id="btn_guardar">Guardar</button>\r\n\t\t\t\t\t\t</div>');
